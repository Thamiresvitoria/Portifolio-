...
const dadosUC = {
    uc1: {
        ...
        descricao: "Nesta etapa, desenvolvemos conhecimentos fundamentais de informática, explorando sistemas operacionais e ferramentas de escritório. Aprendemos a utilizar recursos digitais de forma prática e eficiente para organização, produtividade e realização das atividades.",
        icone: "fa-laptop",
    ...
    uc2: {
        ...
        status: "concluido",
        statusTexto: "CONCLUÍDO",
        descricao: "Nesta etapa, desenvolvemos conhecimentos relacionados à criação e estruturação de sistemas de informação. Trabalhamos conceitos de desenvolvimento, lógica e tecnologia, compreendendo como diferentes recursos podem ser utilizados para criar soluções que atendam às necessidades dos usuários.",
        icone: "fa-globe",
