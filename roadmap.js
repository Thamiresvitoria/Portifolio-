...
const dadosUC = {
  uc1: {
    ...
    descricao:
      "Nesta etapa, desenvolvemos conhecimentos fundamentais de informática, explorando sistemas operacionais e ferramentas de escritório. Aprendemos a utilizar recursos digitais de forma prática e eficiente para organização, produtividade e realização das atividades.",
    icone: "fa-laptop",
    alunoNome: "DACYRRÔSE MELO",
    alunoTexto:
      "Destaca-se pelo comprometimento, organização e dedicação durante as atividades desenvolvidas. Demonstra facilidade no uso de ferramentas tecnológicas e boa capacidade de adaptação aos diferentes recursos apresentados, contribuindo de forma ativa para o desenvolvimento das atividades e para a colaboração com os demais colegas.",
  ...
  uc2: {
    ...
    statusTexto: "CONCLUÍDO",
    descricao:
      "Nesta etapa, desenvolvemos conhecimentos relacionados à criação e estruturação de sistemas de informação. Trabalhamos conceitos de desenvolvimento, lógica e tecnologia, compreendendo como diferentes recursos podem ser utilizados para criar soluções que atendam às necessidades dos usuários.",
    icone: "fa-globe",
    alunoNome: "MESSIAS KAYNÃ",
    alunoTexto:
      "Destaca-se pela dedicação, colaboração e disposição em ajudar os colegas durante as atividades desenvolvidas. Está sempre disposto a compartilhar conhecimentos, tirar dúvidas e apoiar os demais membros da turma, contribuindo para um ambiente mais colaborativo e produtivo. Demonstra também comprometimento e facilidade para trabalhar em equipe.",
  ...
  uc3: {
    ...
    statusTexto: "CONCLUÍDO",
    descricao:
      "Nesta etapa, aprofundamos o planejamento e a estruturação de projetos web, com foco em soluções criativas, funcionais e centradas no usuário.",
    icone: "fa-pen-nib",
    alunoNome: "EVELLYN GOMES",
    alunoTexto:
      "Destaca-se pelo comprometimento, criatividade e excelente desempenho nas atividades desenvolvidas. Demonstra ótima liderança, boa comunicação interpessoal e está sempre disposta a apoiar os demais membros da equipe ao longo das aulas, contribuindo para um ambiente colaborativo e produtivo.",
  ...
  uc4: {
    ...
    statusTexto: "CONCLUÍDO",
    descricao:
      "Nesta etapa, desenvolvemos o portfólio da turma, colocando em prática conhecimentos de planejamento e desenvolvimento de aplicações para a web. Trabalhamos com Figma na criação e organização das interfaces e utilizamos HTML, CSS e JavaScript para transformar os projetos em páginas funcionais, responsivas e interativas, aprimorando nossa experiência com desenvolvimento front-end.",
    icone: "fa-shield-halved",
    alunoNome: "CARLOS HENRIQUE",
    alunoTexto:
      "Destaca-se pelo comprometimento, dedicação e participação durante o desenvolvimento do portfólio da turma. Demonstrou interesse em aprender e aplicar os conhecimentos de Figma, HTML, CSS e JavaScript, contribuindo para a construção das interfaces e para o desenvolvimento das funcionalidades do projeto. Também apresentou boa colaboração com os colegas e disposição para participar das atividades propostas.",
    alunoFoto: "../Assets/Fotos_aluno_130/carlos_henrique.jpg",
  },
  uc5: {
